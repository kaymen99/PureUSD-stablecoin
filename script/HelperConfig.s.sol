...
import {ERC20MockWithDecimals} from "../test/mocks/ERC20MockWithDecimals.sol";
...
contract HelperConfig is Script {
    ...
    function getOrCreateAnvilConfig() public returns (Config memory) {
        ...
        ERC20MockWithDecimals wethMock = new ERC20MockWithDecimals(
            ETH_DECIMALS
        );
        ERC20MockWithDecimals wbtcMock = new ERC20MockWithDecimals(
            BTC_DECIMALS
        );
